...
fun monthlyPrsi ()  = monthlySalary() * (prsiPercentage / 100)
fun monthlyPaye ()  = monthlySalary() * (payePercentage / 100)
fun grossPay()     = (monthlySalary() + (annualBonus/12))
fun totalDeductions() = monthlyPrsi() + monthlyPrsi() + cycleToWorkMonthlyDeduction
...
fun payslip(){
    ...
    println ("|                                                                       |")
    println ("|   Employee Name:  " + firstName.uppercase() + " " + surname.uppercase() + "(" + gender.uppercase() + ")                   " +
